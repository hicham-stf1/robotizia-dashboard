      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 text-gray-600 font-hkgrotesk mb-4">
              Achieve More with Robotizia
            </h2>
            ...
            <div className="swiper-wrapper">
              ...
              <div className="swiper-slide h-auto flex flex-col  p-2 rounded">
                <Testimonial
                  ...
                  but I decided to give Robotizia a try. I was amazed at how well it worked! My
                  students were able to learn more quickly and easily with Robotizia. The questions
                  that it generated really helped to focus their learning and clarify any
                  misunderstandings. I would highly recommend Robotizia to any educator looking for
              ...
              <div className="swiper-slide h-auto flex flex-col  p-2 rounded">
                <Testimonial
                  text="— Robotizia is an amazing tool that has helped me to better understand the
              ...
              <div className="swiper-slide h-auto flex flex-col  p-2 rounded">
                {" "}
                <Testimonial
                  text="— Last year, when I turned to Robotizia, I was a D student. But I knew the
                  potential I had if I could just find the right tools to prepare for my assessments. After
                  using Robotizia, I am now a B-average student. My teachers are really impressed
              ...
              {/* <div className="swiper-slide h-auto flex flex-col  p-2 rounded">
                <Testimonial
                  text="— Robotizia lets me quickly get the insights I care about so that I can focus on my productive work. I've had Robotizia for about 24 hours now and I honestly don't know how I functioned without it before."
                  image={TestimonialImage03}
                  name="Anastasia Dan"
                  logo={ent1}
                  job="UX Designer"
