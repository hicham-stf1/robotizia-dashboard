      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20 text-center md:text-left">
            <h1 className="h1 text-gray-500" data-aos="fade-up">Refreshing news for developers and designers</h1>
          </div>
              ...
              <div data-aos="fade-left" data-aos-delay="200">
                <header>
                  <div className="mb-3">
                    <ul className="flex flex-wrap text-xs font-medium -m-1">
                      <li className="m-1">
                        <Link to="#" className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-indigo-600 hover:bg-indigo-700 transition duration-150 ease-in-out">Product</Link>
                      </li>
                      <li className="m-1">
                  ...
                  <h3 className="h3 text-2xl lg:text-3xl mb-2">
                    <Link to="/blog-post" className="text-gray-400 transition duration-150 ease-in-out">Designing a functional workflow at home.</Link>
                  </h3>
                </header>
                ...
                <footer className="flex items-center mt-4">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600">Jan 19, 2020</span>
                  </div>
                </footer>
              </div>
            </article>
          ...
          <div className="max-w-sm mx-auto md:max-w-none">
            ...
            {/*  Section title */}
            <h4 className="h4 pb-6 mb-10 border-b text-gray-400 border-gray-700" data-aos="fade-up">Latest articles</h4>
              ...
              <article className="flex flex-col h-full" data-aos="fade-up">
                <header>
                  ...
                  <h3 className="h4 mb-2">
                    <Link to="/blog-post" className="hover:text-gray-100 transition duration-150 text-gray-400 ease-in-out">The quick brown fox jumped over the lazy dog.</Link>
                  </h3>
                </header>
                ...
                <footer className="flex items-center mt-4">
                  ...
                  <div className="font-medium">
                    ...
                    <span className="text-gray-600"> - </span>
                    <span className="text-gray-600">Jan 17, 2020</span>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="100">
                ...
                <footer className="flex items-center mt-4">
                  ...
                  <div className="font-medium">
                    ...
                    <span className="text-gray-600"> - </span>
                    <span className="text-gray-600">Jan 12, 2020</span>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
                ...
                <footer className="flex items-center mt-4">
                  ...
                  <div className="font-medium">
                    ...
                    <span className="text-gray-600"> - </span>
                    <span className="text-gray-600">Jan 9, 2020</span>
                  </div>
                </footer>
              </article>
              ...
              <article className="flex flex-col h-full" data-aos="fade-up">
                ...
                <footer className="flex items-center mt-4">
                  ...
                  <div className="font-medium">
                    ...
                    <span className="text-gray-600"> - </span>
                    <span className="text-gray-600">Jan 7, 2020</span>
                  </div>
                </footer>
              </article>
          ...
          {/* <nav className="flex justify-center pt-16" role="navigation" aria-label="Pagination Navigation">
            <ul className="inline-flex flex-wrap font-medium text-sm -m-1">
              <li className="m-1">
                <span className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-4 rounded-full text-gray-600">Prev</span>
              </li>
              <li className="m-1">
                <Link to="#" className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-indigo-600 transition-colors duration-150 ease-in-out">1</Link>
              </li>
              <li className="m-1">
                <Link to="#" className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-indigo-600 transition-colors duration-150 ease-in-out">2</Link>
              </li>
              <li className="m-1">
                <Link to="#" className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-indigo-600 transition-colors duration-150 ease-in-out">3</Link>
              </li>
              <li className="m-1">
                <span className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-600">...</span>
              </li>
              <li className="m-1">
                <Link to="#" className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-2 rounded-full text-gray-300 hover:bg-indigo-600 transition-colors duration-150 ease-in-out">12</Link>
              </li>
              <li className="m-1">
                <Link to="#" className="inline-flex h-10 min-w-10 justify-center items-center bg-gray-800 px-4 rounded-full text-gray-300 hover:bg-indigo-600 transition-colors duration-150 ease-in-out">Next</Link>
              </li>
            </ul>
          </nav> */}
