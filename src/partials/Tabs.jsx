          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              <button
                ...
                onClick={() => setTab(1)}
              >
                <svg className="w-4 h-4 fill-current text-indigo-600 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  ...
                  <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                    ...
                    <a className="btn-sm text-white bg-indigo-600 hover:bg-indigo-700 mt-6" href="#0">
                      <span className="text-sm">Learn more</span>
                      <svg className="w-3 h-3 fill-current text-indigo-400 shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
