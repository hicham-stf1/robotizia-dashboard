  ...
  const [items] = useState([
    {
      img: UserImage01,
      alt: 'Testimonial 01',
      quote: '“ I feel grateful that Robotizia pushed me to expand my horizons and strive to accomplish more, not only in my career but in education as well.“',
      name: 'Darya Semenova',
    ...
    },
    {
      img: UserImage02,
      alt: 'Testimonial 02',
      quote: '“ Not only in my career but in education as well, I feel grateful that Robotizia pushed me to expand my horizons and strive to accomplish more.“',
      name: 'Greg Sebastian',
      role: 'Head of Design'
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-testimonialcar>
            <h2 className="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-testimonialcar]">Join the Robotizia team</h2>
                ...
                {items.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-gray-600 font-medium mt-3">
                      <cite className="text-gray-200 not-italic">{item.name}</cite> / <span className="text-indigo-600">{item.role}</span>
                    </div>
                  </Transition>
                ))}
