    ...
    return (
        <div>
            <div className="flex flex-col rounded-xl shadow-lg h-full p-6 bg-gray-50 border-2 border-gray-200" data-aos="fade-up">
                ...
                <blockquote className="text-lg text-gray-600 grow">{text}</blockquote>
                <div className="text-gray-600 flex space-x-4  font-medium mt-6 pt-5 border-t border-gray-700">
                    <div>
                    ...
                    <div className='flex-col flex'>
                        ...
                        <a className="text-indigo-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">{job}</a>
                    </div>
