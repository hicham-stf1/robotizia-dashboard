...
import iPhone from "../images/2.png";
...
function HeroHome() {
  ...
  return (
    <section>
      <div className="max-w-6xl h-screen mx-auto px-4 sm:px-6 relative">
        {/* <div className="App">
          {showForm ? <String /> : <><h3>$100.00</h3> <img src={iPhone} /> <button onClick={() => setShowForm(true)}>BUY</button></>}
        </div> */}
        ...
        {/* Hero content */}
        <div className="relative text-gray-600  pt-32 pb-10 md:pt-40 md:pb-16">
          {/* Section header */}
          <div className="max-w-3xl  mx-auto text-center pb-12 md:pb-16">
            <p className="text-7xl mb-4  font-bold " data-aos="fade-up">
              <span className="space-y-2">
                Transform the way you do{" "}
                <span className="border-2 text-6xl border-indigo-500 border-dashed ">
                  things.
                </span>
              </span>
            </p>
            <div className="text-indigo-400 h-[170px] text-3xl font-medium my-3 sm:my-6">
              <Typed
                strings={[
                  "Transforming businesses with AI technology",
                  "AI solutions tailored to your needs",
                  "Revolutionize your business with AI",
                  "The future is AI, and we're here to lead the way",
                  "Maximizing efficiency and productivity with AI",
            ...
            <p
              className="text-2xl sm:w-[80%] sm:mx-[10%] text-gray-400 mb-8"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              An AI-powered business intelligence and knowledge discovery platform for entrepreneurs and executives
            </p>

            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a
                  className="btn py-4 text-white border-2 rounded-full  bg-indigo-600 hover:bg-indigo-700 w-full mb-4 sm:w-auto sm:mb-0"
                  href="#0"
                >
                  Start free trial{" "}
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <a
                  className="btn py-4  text-indigo-500 bg-white border-2 border-indigo-500 rounded-full  w-full sm:w-auto sm:ml-4"
                  href="#0"
                >
                  Learn more{" "}
