        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <article>
              ...
              <header className="mb-8">
                ...
                <div className="text-center md:text-left">
                  <h1 className="h1 mb-4 text-gray-500" data-aos="fade-up">Designing a functional workflow at home.</h1>
              ...
              <div className="text-lg text-gray-400">
                ...
                <figure className="mb-8">
                  ...
                  <figcaption className="text-sm text-center text-gray-600 mt-3">Photo by Helena Lopes on Unsplash</figcaption>
                </figure>
              ...
              <footer>
                <div className="md:flex md:items-center md:justify-between text-center md:text-left">
                  ...
                  <ul className="inline-flex mt-4 md:ml-4 md:mb-0">
                    <li>
                      <Link to="#" className="flex justify-center items-center text-indigo-600 bg-gray-800 hover:text-gray-100 hover:bg-indigo-600 rounded-full transition duration-150 ease-in-out">
          ...
          <aside className="mt-20">
            <div className="max-w-sm mx-auto md:max-w-none">
              ...
              {/* Section title */}
              <h4 className="h4 py-6 mb-10 border-t border-b text-gray-500 border-gray-700">More from Robotizia</h4>
              ...
              <div className="grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
                ...
                <article className="flex flex-col h-full" data-aos="fade-up">
                  <header>
                    ...
                    <h3 className="h4 mb-2">
                      <Link to="/blog-post" className="text-gray-400 transition duration-150 ease-in-out">quick brown fox jumped over the lazy dog</Link >
                    </h3>
                  </header>
                ...
                <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="200">
                  <header>
                    ...
                    <h3 className="h4 mb-2">
                      <Link to="/blog-post" className="text-gray-400 transition duration-150 ease-in-out">The quick brown fox jumped over the lazy dog.</Link>
                    </h3>
                  </header>
                  <p className="text-lg text-gray-400 grow">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                  <footer className="flex items-center mt-4">
                ...
                <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <footer className="flex items-center mt-4">
                    ...
                    <div className="font-medium">
                      ...
                      <span className="text-gray-600"> - </span>
                      <span className="text-gray-600">Jan 2, 2020</span>
                    </div>
                  </footer>
                </article>
