...
function Service({ tool }) {
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-4 cursor-pointer bg-[#F7FAFC] hover:bg-[#eaedfd]  shadow-lg rounded-sm border-[2px] border-slate-200 hover:border-[#6d7eef] rounded-xl text-[#586bed] hover:text-[#2e46e8]">
