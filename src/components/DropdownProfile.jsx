  ...
  return (
    <div className="relative inline-flex">
      {true && (
        ...
        >
          <img
            className="w-8 h-8 rounded-full border-[#8290f1] border-[2px]"
          ...
          <div className="flex items-center truncate">
            <div className="hidden text-black md:flex flex-col text-start mr-2">
              <span className="truncate ml-2 text-sm font-medium">
                John Doe
              </span>
              <span className="truncate ml-2 text-[10px] font-medium">
                @johndoe
              </span>
            </div>
            <svg
